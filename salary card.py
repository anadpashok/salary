...
# # print(total_cost_to_company)
# print("Basic Salary:",basic_salary)
# print("HRA:",HRA)
# print("Special Allowance:",Special_Allowance)
# print("Employer PF:",employer_pf)
# print("Employer ESI:",employer_ESI)
# print("Base Salary:",base_salary)
# print("Annual Short-Term Bonus:",annual_short_term_bonus)
# print("Other Allowance(internet):",other_allowance)
# print("Total Cost To Company:",total_cost_to_company)
